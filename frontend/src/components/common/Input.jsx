  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ref={ref}
          className={`w-full bg-slate-50 dark:bg-[#07090E] border ${
            error ? 'border-rose-500 focus:ring-rose-500/40' : 'border-slate-300 dark:border-slate-800/90 focus:border-blue-500 focus:ring-blue-500/40'
